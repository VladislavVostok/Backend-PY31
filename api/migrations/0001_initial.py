# Generated by Django 4.2.1 on 2024-05-21 17:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('Processing', 'В процессе'), ('Rejected', 'Отклонён'), ('Access', 'Успешно')], default='Processing', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('language', models.CharField(choices=[('English', 'English'), ('Spanish', 'Spanish'), ('French', 'French'), ('Russian', 'Русский')], default='Russian', max_length=100)),
                ('level', models.CharField(choices=[('Beginner', 'Начинающий'), ('Intemediate', 'Продвинутый'), ('Advanced', 'Мастер')], default='Beginner', max_length=100)),
                ('platform_status', models.CharField(choices=[('Review', 'Проверяется'), ('Disabled', 'Отключен'), ('Rejected', 'Отклонён'), ('Draft', 'Черновик'), ('Published', 'Опубликован')], default='Published', max_length=100)),
                ('teacher_course_status', models.CharField(choices=[('Draft', 'Черновик'), ('Disabled', 'Отключен'), ('Published', 'Опубликованный')], default='Published', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Draft', 'Черновик'), ('Published', 'Опубликован')], max_length=100)),
